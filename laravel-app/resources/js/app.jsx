...
const cardImages = {
    webApp: '/card-bg/web-app.svg',
    mobile: '/card-bg/mobile-app.svg',
    backend: '/card-bg/server-flow.svg',
    database: '/card-bg/data-grid.svg',
    quality: '/card-bg/interface-quality.svg',
    student: '/card-bg/student-system.svg',
    booking: '/card-bg/venue-booking.svg',
    visualizer: '/card-bg/data-visualizer.svg',
    smartgrow: '/card-bg/smartgrow.svg',
    delivery: '/card-bg/operations-flow.svg',
    communication: '/card-bg/communication.svg',
    learning: '/card-bg/learning.svg',
    leadership: '/card-bg/leadership.svg',
    education: '/card-bg/education.svg',
    certificate: '/card-bg/certificate.svg',
};
...
const projects = [
    {
        ...
        detail: 'Laravel, MySQL, access rules, validation, and practical dashboard workflows.',
        tags: ['Laravel', 'MySQL', 'Tailwind CSS', 'Dashboards'],
    ...
    },
    {
        ...
        detail: 'React screens, Laravel workflows, Supabase data, and mobile-first booking logic.',
        tags: ['Laravel', 'Supabase', 'React.js', 'Tailwind CSS'],
...
const capabilities = [
    ...
    },
    {
        ...
        copy: 'Routing, validation, server-side workflows, access control, and maintainable PHP logic.',
...
const buildStages = [
    ...
    },
    {
        ...
        copy: 'React, Laravel, PHP, MySQL, Supabase, and validation logic are wired into one product flow.',
    },
];
...
const homeSignals = [
    ...
    },
    {
        ...
        copy: 'Routing, validation, server-side behavior, access rules, and maintainable PHP systems.',
    },
    {
        value: 'Data',
...
const stackGroups = [
    ...
    { title: 'Backend', items: ['PHP', 'Laravel', 'Java'] },
...
const capabilityDetails = [
    ...
    },
    {
        ...
        copy: 'Laravel routing, validation, PHP workflows, Java fundamentals, debugging, and maintainable server behavior.',
    },
    {
...
const educationItems = [
    ...
    },
    {
        ...
        copy: 'Continuous learning across React, Laravel, UI/UX design, database management, testing, and mobile app basics.',
        ...
        <div className="app-shell">
            ...
            <header className="topbar">
                <div className="container-max nav-row">
                    <a href="/" className="brand-link" onClick={(event) => handleNav(event, '/', navigate)}>
                        <span>Vincent</span>
                        <span>Luhanga</span>
                    </a>
                ...
                <div className="container-max hero-window">
                    <div className="hero-copy">
                        ...
                        <p className="reveal">
                            ...
                            interface systems with React, Laravel, PHP, MySQL, Supabase, and careful UI thinking.
                        </p>
                        <div className="hero-actions reveal">
                            <a className="action-button" href="/projects" onClick={(event) => handleNav(event, '/projects', navigate)}>
                                <span>View projects</span>
                                <ArrowRight size={19} weight="Bold" />
                            </a>
                            <a className="action-button secondary" href="/capabilities" onClick={(event) => handleNav(event, '/capabilities', navigate)}>
...
function createDesktopTexture(nightMode = false) {
    ...
    return createCanvasTexture(1024, 620, (context, width, height) => {
        ...
        context.fillText('React / Laravel / MySQL', 70, 154);
        context.fillStyle = palette.accent;
    ...
    return (
        <div className="three-model-stage reveal" ref={mountRef} data-mode={nightMode ? 'night' : 'day'}>
            ...
            <nav className="sr-only" aria-label="3D desktop fallback links">
                {desktopLinks.map((link) => <a key={link.path} href={link.path}>{link.label}</a>)}
            </nav>
        </div>
    );
}
...
function FeatureLink({ icon: Icon, title, copy, path, navigate }) {
    return (
        <a className="feature-link reveal" href={path} onClick={(event) => handleNav(event, path, navigate)}>
    ...
    return (
        <footer className="site-footer">
            <div className="container-max footer-layout">
                <div>
                    <a href="/" className="footer-brand" onClick={(event) => handleNav(event, '/', navigate)}>
                ...
                <nav className="footer-links" aria-label="Footer navigation">
                    <a href="/projects" onClick={(event) => handleNav(event, '/projects', navigate)}><Folder size={18} weight="Bold" />Projects</a>
                    <a href="/capabilities" onClick={(event) => handleNav(event, '/capabilities', navigate)}><ChartSquare size={18} weight="Bold" />Capabilities</a>
                    <a href="/experience" onClick={(event) => handleNav(event, '/experience', navigate)}><CalendarMark size={18} weight="Bold" />Experience</a>
                    <a href="/contact" onClick={(event) => handleNav(event, '/contact', navigate)}><Letter size={18} weight="Bold" />Contact</a>
                </nav>
            ...
            <section className="project-hero">
                <div className="container-max project-hero-grid">
                    <div className="project-hero-copy reveal">
                        ...
                        <a className="action-button compact" href="/capabilities" onClick={(event) => handleNav(event, '/capabilities', navigate)}>
                            <span>View capabilities</span>
    ...
    return (
        <>
            <PageHeading
                ...
                copy="I work across product UI, Laravel systems, data workflows, and delivery quality without separating design from implementation."
            />
            ...
            <section className="section-pad">
                <div className="container-max frame-card inner reveal">
                    <div className="contact-layout">
                        ...
                        <div>
                            {config.flashStatus && <p className="status-message">{config.flashStatus}</p>}
                            <form action={config.contactAction} method="POST" className="contact-form">
                                <input type="hidden" name="_token" value={config.csrfToken || ''} />
                                <Field id="name" label="Name" name="name" defaultValue={old.name || ''} error={errors.name?.[0]} />
                                <Field id="email" label="Email" name="email" type="email" defaultValue={old.email || ''} error={errors.email?.[0]} />
                                <Field id="message" label="Message" name="message" textarea defaultValue={old.message || ''} error={errors.message?.[0]} />
